...
class Choice(models.Model): #선택지
    Content = models.CharField(max_length=100)
    FK_Questions_id = models.ForeignKey(to='api.Questions', on_delete=models.CASCADE,related_name='Fkque')
    FK_Sep = models.ForeignKey(to='api.Sep_models', on_delete=models.CASCADE,related_name='Fksep')
